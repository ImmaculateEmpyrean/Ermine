...
namespace Ermine
{
	...
	public:
		...
		TileSelectedEventSubscription(std::function<void(TileSelectedEvent*)> CallableObject);
		TileSelectedEventSubscription(std::function<void(TileSelectedEvent*)> CallableObject, std::atomic<bool>& Flag);
